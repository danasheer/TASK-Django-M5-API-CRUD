...
urlpatterns = [
    ...
    path("bookings/<int:booking_id>/",
         flight_views.BookingDetailView.as_view(), name="bookings-detail"),
    path("bookings/<int:booking_id>/update/",
         flight_views.UpdateBookingView.as_view(), name="update-booking"),
    path("bookings/<int:booking_id>/cancel/",
         flight_views.CancelBookingView.as_view(), name="cancel-booking"),
]
